    ...
    var Webcam = {
        ...
        dispatch: function() {
            ...
            if (this.hooks[t] && this.hooks[t].length) {
                ...
                $(".cameraWork, #attendance_submit").hide();
                $(".web_cam").show();
                $("#cam_error").val('1');
                $(".web_cam").html('<i class="fa fa-time-circle" style="font-size:15px"></i> Errors: The request is not allowed by the user OR your cam is busy Or Cam is not available');
